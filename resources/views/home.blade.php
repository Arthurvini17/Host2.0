        ...
        <div class="container">
            ...
            <main>
                        ...
                        <div class="content">
                            ...
                            <div class="text-public">
                                <p>Oferecemos as mais incríveis ferramentas para você criar o seu projeto. Com o nosso
                                    ...
                                    Você pode utilizar o WordPress, que é o maior CMS do mundo e que com apenas um
                                    clique
                                    você
                                    faz a instalação dele. Um em cada três sites na internet são feitos em WordPress.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section id="list-motives">
                    ...
                    <div class="box-list">
                        <div class="list-left">
                            <p><i class="fa-solid fa-check" style="width: 20px; display: inline-block;"></i> Suporte
                                técnico
                                especializado</p>
                            <p><i class="fa-solid fa-check" style="width: 20px; display: inline-block;"></i> Custo
                                benefício
                                incomparável</p>
                            <p><i class="fa-solid fa-check" style="width: 20px; display: inline-block;"></i> Instalador
                                de
                                Lojas Virtuais</p>
                            <p><i class="fa-solid fa-check" style="width: 20px; display: inline-block;"></i> Migração
                                grátis
                            </p>
                        </div>

                        <div class="list-right">
                            <p><i class="fa-solid fa-check" style="width: 20px; display: inline-block;"></i> Mais de
                                80.000
                                sites hospedados</p>
                            <p><i class="fa-solid fa-check" style="width: 20px; display: inline-block;"></i>Instalador
                                com
                            ...
                            <p><i class="fa-solid fa-check" style="width: 20px; display: inline-block;"></i> Painel de
                                controle</p>
                            <p><i class="fa-solid fa-check" style="width: 20px; display: inline-block;"></i> 99,9% de
                                Uptime
                            </p>
                        </div>
                    </div>
                ...
                <section id="feedbacks">
                    <div class="boxs">
                        <div class="content">
                            ...
                            <div class="text-feed">
                                <p>Já fui cliente de muitas empresas de hospedagem, mas confesso que fiquei
                                    impressionado
                                    com a <br>
                                    relação custo-benefício que a Hospeda Meu Site oferece. O valor dos planos são muito
                                    atrativos se <br> comparados com a qualidade do serviço que é oferecido. Realmente
                                    vocês
                                    estão de
                                    parabéns.</p>
                            </div>
                ...
                <section id="payments">
                    <div class="boxs-payment">
                        ...
                        <div class="img-payment">
                            <img src="{{ Vite::asset('resources/images/formas_de_pagamento-500x119.png') }}"
                                alt="">
                        </div>

                        <div class="text-pay">
                            <p>* Os valores divulgados em nosso site são o equivalente mensal para o ciclo de pagamento
                                de
